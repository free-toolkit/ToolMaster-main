                ...
                <div class="tool-grid">
                    <div class="tool-card">
                        ...
                        <div class="input-group">
                            <input type="url" id="video-url" class="input-field" placeholder="https://youtube.com/watch?v=...">
                        </div>
                        <button class="btn tool-btn" onclick="app.processVideoDownload()">🚀 Descargar Video</button>
                    </div>
                    <!-- Más herramientas de video... -->
                </div>
            </section>
        `;
    }
